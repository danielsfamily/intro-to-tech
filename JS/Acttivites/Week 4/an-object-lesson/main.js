...
console.log(myPersevereCodeObj.isAnExcellentObject);

// Add the property `term` and set it to 1.

myPersevereCodeObj.term = 1;
console.log(myPersevereCodeObj.term); 
...
console.log(myPersevereCodeObj.currentScore);
...
myself.address.push('14261 Central Pike');
myself.address.push('Mt Juliet,TN');
myself.address.push('37122');
...
const myNewObject = {
  ...
  isSmallCity: True,
  population: 5000,
  landmarks: ["Post Office", "Barber Shop", "Ziggy's Pizza"],
  "incorpriated-area": "25 miles",
  "1stMayor": "John Parker" 
};
